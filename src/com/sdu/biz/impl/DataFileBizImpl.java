...
public class DataFileBizImpl {
	...
	public List<Object> getAllByUseId(int userid,int offset,int pageSize,String suffix){
		return dataFileDao.getByUserId(userid,offset,pageSize,suffix);
	}
	...
	public List<Object> getAllByProjectId(int userId, int project_id, int offset, int pageSize,String suffix) {
		return dataFileDao.getDataFilesByProjectId(userId,project_id,offset,pageSize,suffix);
	}
	public List<Object> getAllByProjectIdAndDataFileType(int adminId,int project_id, String datafile_type, int offset, int pageSize,String suffix) {
		return dataFileDao.getDataFilesByProjectIdAndDataFileType(adminId,project_id, datafile_type,offset,pageSize,suffix);
	}
	...
	public int getCountByUserId(int userId,String suffix){
		return dataFileDao.getCountByUserId(userId,suffix);
	}
	public int getCountByProjectId(int userId,int project_Id,String suffix) {
		return dataFileDao.getCountByProjectId(userId,project_Id,suffix);
	}
	public int getCountByProjectIdAndDatafileType(int userId,int project_id,String datafile_type,String suffix){
		return dataFileDao.getCountByProjectIdAndDataFileType(userId, project_id, datafile_type,suffix);
	}
	...
	public List<Object> selectDataFile(String d_suffix) {
		return dataFileDao.selectDataFile(d_suffix);
	}
	public int selectDataFileCount(String d_suffix) {
		return dataFileDao.selectDataFileCount(d_suffix);
	}
}
